    ...
    window.location="../menu"</script>';
        ...
        window.location="../menu" </script>';
            ...
            if (move_uploaded_file($_FILES['foto']['tmp_name'], $target_file)) {
                $query = mysqli_query($conn, "INSERT INTO tb_menu (foto,nama_menu,keterangan,kategori,harga) values ('".$kode_rand . $_FILES['foto']['name'] . "','$nama_menu','$keterangan','$kategori','$harga')");
                if ($query) {
